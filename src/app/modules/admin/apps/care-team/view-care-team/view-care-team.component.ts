...
export class ViewCareTeamComponent implements OnInit {
  ...
  /**
   ...
   updateUser() {
    let name = this.careTeamForm.get('name').value;
    ...
    const body = {
      ...
      adminaccount: this.data.careTeam.admin_account,
      isadminaccount: this.data.careTeam.isadmin_account,
      undermainbranch: this.data.careTeam.under_mainbranch
    };
  ...
  SaveActivity() {
    const desc = "Updated <b>"+this.careTeamForm.get('name').value+" - Care Coordinator </b> details";
    const body = {
      activityid: 0,
