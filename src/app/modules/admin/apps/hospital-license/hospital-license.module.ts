...
import { HosplitalLicenseRoutes } from './hospital-license.routing';
...
@NgModule({
    declarations: [
        HosplitalLicenseComponent,
        ViewHospitalLicenseComponent,
        AddHospitalLicenseModalComponent
    ],
    imports     : [
        RouterModule.forChild(HosplitalLicenseRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
...
export class HosplitalLicenseModule
{
}
