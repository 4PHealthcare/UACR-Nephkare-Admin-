...
export class PaymentsComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnInit(): void {
      ...
      // Get the products
      this.products$ = this._usersService.products$;
      ...
      this.searchInputControl.valueChanges
        .pipe(
          ...
          switchMap((query) => {
            this.closeDetails();
            this.isLoading = true;
            return this._usersService.getProducts(0, 10, 'name', 'asc', query);
          }),
          map(() => {
        ...
        merge(this._sort.sortChange, this._paginator.page)
          .pipe(
            switchMap(() => {
              this.closeDetails();
              this.isLoading = true;
              return this._usersService.getProducts(
    ...
    getPatientsInfo() {
        const url = `api/User/GetUsers?roleid=3`
      this.httpService
        .getAll(url)
        .subscribe((res: any) => {
    ...
    toggleDetails(productId: string): void {
      ...
      this._usersService.getProductById(productId).subscribe((product) => {
    ...
    createTag(title: string): void {
      ...
      this._usersService.createTag(tag).subscribe((response) => {
    ...
    createProduct(): void {
      // Create the product
      this._usersService.createProduct().subscribe((newProduct) => {
        // Go to new product
    ...
    updateSelectedProduct(): void {
      ...
      this._usersService.updateProduct(product.id, product).subscribe(() => {
    ...
    deleteSelectedProduct(): void {
      ...
      confirmation.afterClosed().subscribe((result) => {
        ...
        if (result === 'confirmed') {
          ...
          this._usersService.deleteProduct(product.id).subscribe(() => {
            // Close the details
            this.closeDetails();
          });
        }
